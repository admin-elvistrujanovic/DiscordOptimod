...
class Main : IXposedHookZygoteInit, IXposedHookLoadPackage, IXposedHookInitPackageResources {
    ...
    override fun handleLoadPackage(param: XC_LoadPackage.LoadPackageParam) {
        ...
        val patch = object : XC_MethodHook() {
            override fun beforeHookedMethod(param: MethodHookParam) {
                val url = if (config.customLoadUrl.enabled) config.customLoadUrl.url else "https://raw.githubusercontent.com/Opti-mod/Opti/rewrite/dist/vendetta.js"
                try {
                    ...
                    Log.e("Optimod", "Failed to download Optimod from $url")
                }
